    ...
    m.prototype.config = {
        ...
        n.elem.attr("lay-arrow", n.arrow), n.elem.find("." + u)[0] && n.elem.find("." + u).remove(), n.elem.append(t), t.on("click", function () {
            ...
            if(originalFileTypeName == "" || originalFileTypeName == null){
                ...
                if($(".carousel-item").find(".layui-this").find("input[name='originalFileTypeName']").hasClass("borderRed")){
                    $(".carousel-item").find(".layui-this").find("input[name='originalFileTypeName']").removeClass("borderRed");
                }
